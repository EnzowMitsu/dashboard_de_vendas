...
def menssagem():
    sucesso = st.success('Arquivo baixado', icon = "✅")
    time.sleep(5)
    sucesso.empty()
...
with coluna1:
    ...
    nome_arquivo += '.csv' 
with coluna2:
    st.download_button('baixar', data = converte_csv(dados_filtrados), file_name= nome_arquivo, mime= 'text/csv', on_click= menssagem)
